  ...
  return (
    <>
      ...
      <div className="heroSection h-100 flex flex-col justify-center px-6 gap-y-4 md:px-10 lg:px-16">
        <h1 className="font-bold tracking-wide text-3xl max-w-sm md:text-4xl md:max-w-md lg:max-w-2xl">
          {titlePage}
        </h1>
        <h3 className="font-semibold text-xl tracking-wide md:max-w-xl">
          {descPage}
        </h3>
        {pathname === "/HomePage" && (
      ...
      <div className="w-11/12 lg:w-[85%] mx-auto my-10">{children}</div>
      <Footer />
    </>
  );
}
